...
const AboutMe = () => {
  ...
  return (
    <div className="flex flex-col text-center gap-8 justify-center mt-24 w-full lg:max-w-4xl mx-auto font-mono">
        ...
        {/* About me */}
        <div className="flex-col text-[18px] text-white mx-auto">
            <p className="font-mono text-left">
                <button className="cursor-pointer hover:text-red-500 duration-150" onClick={copyUrl}>{isCopied ? ' Copied! ' : ' [Share] ' } </button> Hello, Stranger! <span className="text-blue-600">My Name is Naman Matoliya, I was born in 2001 in India </span> 
